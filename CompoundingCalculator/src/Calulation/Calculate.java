...
public class Calculate {
	...
	{
		System.out.println("请选择单利计算或复利计算:");
		System.out.println("复利选1，单利选2,本金计算选3,投资预期年份计算选4,投资预期利率计算选5,定额复利投资递增性选6,贷款月还款金额计算选7");
		...
		scanner.close(); 									//如果用了try~catch包围监测错误的话要用scanner.close()方法,清空I/O流，防止scanner重读占用资源
	}
